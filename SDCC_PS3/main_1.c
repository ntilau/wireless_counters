...
void main() {
  ...
  //wr_command(0x96, 0x61); // Receiver control command. VDI slow + 400 kHz + RSSI @ -85dBm
  //wr_command(0xC2, 0xEC); // Data Filter. Automode + digitalRC + last nibble : C->F
  ...
  //wr_command(0x98, 0x30); // 60kHz, MAX Pout
